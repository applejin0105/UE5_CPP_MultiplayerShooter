...
// AMenuSystemCharacter -> ThisClass Replacable
AMenuSystemCharacter::AMenuSystemCharacter():
	// Binding Delegate each function
	...
	if (OnlineSubsytem)
	{
		...
		if (GEngine)
		{
			GEngine->AddOnScreenDebugMessage(
			                                 ...
			                                 15.f,
			                                 FColor::Red,
			                                 FString::Printf(TEXT("Found Sybsystem %s"), *OnlineSubsytem->GetSubsystemName().ToString())
			                                );
		}
	}
}
		...
		if (MatchType == FString("FreeForAll"))
		{
			if (GEngine)
			{
				GEngine->AddOnScreenDebugMessage(
				                                 ...
				                                 15.f,
				                                 FColor::Cyan,
				                                 FString::Printf(TEXT("Joning Match Type: %s"), *MatchType)
				                                );
			}
